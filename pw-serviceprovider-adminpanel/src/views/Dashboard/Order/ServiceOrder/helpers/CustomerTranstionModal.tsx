...
const CustomerTranstionModal = ({ visible, toggle }: any) => {
    const [form] = useForm()
    function onCancel() {
        toggle(null)
    }
    return (
        <Modal
            width={'600px'}
            title={<h3 className="text-[18px] font-semibold">Customer Transaction</h3>}
...
export default CustomerTranstionModal
