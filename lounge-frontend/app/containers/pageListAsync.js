...
export const Onboarding = loadable(() => import("./Pages/Onboarding"), {
  fallback: <Loading />,
});
...
export const Lounge = loadable(() => import("./Pages/Lounge"), {
  fallback: <Loading />,
});
export const Wallet = loadable(() => import("./Pages/Wallet"), {
  fallback: <Loading />,
});
export const EarningHistory = loadable(() => import("./Pages/EarningHistory"), {
  fallback: <Loading />,
});
export const Support = loadable(() => import("./Pages/Support"), {
  fallback: <Loading />,
});
export const LearningCenter = loadable(() => import("./Pages/LearningCenter"), {
  fallback: <Loading />,
});
...
export const CertificateOfSale = loadable(
  () => import("./Pages/CertificateOfSale"),
  {
    fallback: <Loading />,
  }
);
