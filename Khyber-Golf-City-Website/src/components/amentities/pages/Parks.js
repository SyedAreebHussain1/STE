...
import img1 from "./photos/park/1.jpg";
import img2 from "./photos/park/2.jpg";
import img3 from "./photos/park/3.jpg";
import AOS from "aos";
  ...
  return (
    <>
      <header className="header-other-bg">
        <Navbar />
        <OtherHeader
          name1={data == "ur" || data == "ps" ? t("amen102") : t("amen101")}
          name2={data == "ur" || data == "ps" ? t("amen101") : t("amen102")}
        />
      </header>
      <div
        data-aos="fade-up"
