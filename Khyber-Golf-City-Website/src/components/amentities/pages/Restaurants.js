...
import img1 from "./photos/cafe/1.jpg";
import img2 from "./photos/cafe/2.jpg";
import img3 from "./photos/cafe/3.jpg";
import AOS from "aos";
  ...
  return (
    <>
      <header className="header-other-bg">
        <Navbar />
        <OtherHeader
          name1={data == "ur" || data == "ps" ? t("amen22") : t("amen21")}
          name2={data == "ur" || data == "ps" ? t("amen21") : t("amen22")}
        />
      </header>
      <div
        data-aos="fade-up"
