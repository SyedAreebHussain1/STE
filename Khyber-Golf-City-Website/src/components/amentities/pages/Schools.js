...
import img1 from "./photos/school/1.jpg";
import img2 from "./photos/school/2.jpg";
import img3 from "./photos/school/3.jpg";
import AOS from "aos";
  ...
  return (
    <>
      <header className="header-other-bg">
        <Navbar />
        <OtherHeader
          name1={data == "ur" || data == "ps" ? t("amen92") : t("amen91")}
          name2={data == "ur" || data == "ps" ? t("amen91") : t("amen92")}
        />
      </header>
      <div
        data-aos="fade-up"
