...
import img1 from "./photos/sc/1.jpg";
import img2 from "./photos/sc/2.jpg";
import img3 from "./photos/sc/3.jpg";
import AOS from "aos";
  ...
  return (
    <>
      <header className="header-other-bg">
        <Navbar />
        <OtherHeader
          name1={data == "ur" || data == "ps" ? t("amen32") : t("amen31")}
          name2={data == "ur" || data == "ps" ? t("amen31") : t("amen32")}
        />
      </header>
      <div
        data-aos="fade-up"
