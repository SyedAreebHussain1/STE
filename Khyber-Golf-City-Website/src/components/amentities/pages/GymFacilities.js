...
import img1 from "./photos/gym/1.jpg";
import img2 from "./photos/gym/2.jpg";
import img3 from "./photos/gym/3.jpg";
import AOS from "aos";
  ...
  return (
    <>
      <header className="header-other-bg">
        <Navbar />
        <OtherHeader
          name1={data == "ur" || data == "ps" ? t("amen52") : t("amen51")}
          name2={data == "ur" || data == "ps" ? t("amen51") : t("amen52")}
        />
      </header>
      <div
        data-aos="fade-up"
