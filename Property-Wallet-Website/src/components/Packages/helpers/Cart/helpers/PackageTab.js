  ...
  return (
    <div>
      <div className="package-main-addons">
        <PackageAddon
          label={"User Limits"}
          value={data?.[title]?.userLimits && data?.[title]?.userLimits}
        ...
        <PackageAddon
          label={"Listings"}
          value={data?.[title]?.listings && data?.[title]?.listings}
          setStateHelper={setStateHelper}
          stateName={"listings"}
          title={title}
          basePrices={basePrices}
        ...
        <PackageAddon
          label={"Hot Listings"}
          value={data?.[title]?.hotListings && data?.[title]?.hotListings}
          setStateHelper={setStateHelper}
        ...
        {data?.[title]?.website && (
          <PackageAddon
            ...
            intervals={50}
            value={data?.[title]?.appointsments && data?.[title]?.appointsments}
            setStateHelper={setStateHelper}
