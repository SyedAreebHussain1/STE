...
import img1 from "../images/pwinventory/1.png";
import img2 from "../images/pwinventory/2.png";
import img3 from "../images/pwinventory/3.png";
import img4 from "../images/pwinventory/4.png";
import img5 from "../images/pwinventory/5.png";

import AOS from "aos";
import "aos/dist/aos.css";
import "../V2/styleareeb.css";

const ApartmentCustomerVerificationApp = (props) => {
  let publicUrl = process.env.PUBLIC_URL + "/";

  let CustomClass = props.customClass ? props.customClass : "";

  var testClassvar = document.getElementsByClassName("testClass01");
  useEffect(() => {
    for (var i = 0; i < testClassvar.length; i++) {
      testClassvar[i].addEventListener("click", function () {
        var current = document.getElementsByClassName("activeTest01");
        current[0].className = current[0].className.replace(
          " activeTest01",
          ""
        );
        this.className += " activeTest01";
      });
    }
  }, [testClassvar]);
  ...
  return (
    <>
      <div className="container " style={{ textAlign: "", marginTop: "5%" }}>
        <span
          style={{
            lineHeight: "1.3",
            marginTop: "0",
      ...
      >
        ...
        >
          <div className="ltn__tab-menu">
            ...
            >
              <a
                className="testClass01 activeTest01 show anchorTag"
                data-bs-toggle="tab"
                href="#liton_tab_3_7"
              >
                <div className="flexs imgandp">
                  <img className="iconpng" src={inventoryIcon} alt="logo" />
                  <p className="text-inven">PW Inventory</p>
                </div>
              </a>
              <a
                className="anchorTag testClass01"
                data-bs-toggle="tab"
                href="#liton_tab_3_8"
              >
                <div className="flexs imgandp">
                  <img className="iconpng" src={stafficon} alt="logo" />
                  <p className="text-inven">Project Details</p>
                </div>
              </a>
              <a
                className="anchorTag testClass01"
              ...
              >
                <div className="flexs imgandp">
                  ...
                  <p className="text-inven">Available Inventories</p>
                </div>
              </a>
              <a
                className="anchorTag testClass01"
              ...
              >
                <div className="flexs imgandp">
                  ...
                  <p className="text-inven">Property Information</p>
                </div>
              </a>
              <a
                className="anchorTag testClass01"
              ...
              >
                <div className="flexs imgandp">
                  ...
                  <p className="text-inven">Inventory Booking</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div className="tab-content">
            <div className="tab-pane fade  active show" id="liton_tab_3_7">
              <div>
                <div
            ...
            <div className="tab-pane fade" id="liton_tab_3_8">
            ...
            <div className="tab-pane fade" id="liton_tab_3_9">
              <div className="ltn__product-tab-content-inner">
                <div
                  className="flext-text"
                  style={{ display: "flex", flexDirection: "row" }}
            ...
            <div className="tab-pane fade" id="liton_tab_3_10">
              <div className="ltn__product-tab-content-inner">
                <div
                  className="flext-text"
                  style={{ display: "flex", flexDirection: "row" }}
            ...
            <div className="tab-pane fade" id="liton_tab_3_11">
              <div className="ltn__product-tab-content-inner">
                <div
                  className="flext-text"
                  style={{ display: "flex", flexDirection: "row" }}
...
export default ApartmentCustomerVerificationApp;
