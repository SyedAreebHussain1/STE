...
import saleOrderProductColumns from "../../../../../Tables/saleOrderProductColumns.json";
import { Button, Table, Tag } from "antd";
import moment from "moment";
const SaleOrderProductTable = ({ data, onShowSizeChange }) => {
        ...
        return tableData.push({
          sellingPointName: (
            <span style={{ textTransform: "capitalize" }}>
              {item?.propertyWalletProductSaleQuotation?.createdByUser?.profile
                ?.agency?.agencyName
                ? item?.propertyWalletProductSaleQuotation?.createdByUser
          ...
          // projectName: <span style={{ textTransform: "capitalize" }}></span>,
          size: (
            <span style={{ textTransform: "capitalize" }}>
