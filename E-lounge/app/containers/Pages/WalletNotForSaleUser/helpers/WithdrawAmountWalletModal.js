...
import {
  getBanksListNotForSaleUserAction,
  postWithdrawAmountNotForSaleUserAction,
} from "../../../../redux/modules/WalletNotForSaleUser/actions";

function WithdrawAmountWalletModal({
  open,
  close,
  classes,
  toggleSuccessModal,
  ...
  const banks = useSelector((state) =>
    state.getIn(["getAllBanksNotForSaleUser"])
  );
  ...
  function handleSubmit(e) {
    ...
    if (Number(state.withdrawAmount) < 3000) {
      ...
      postWithdrawAmountNotForSaleUserAction(body, dispatch, onSuccess);
    }
  }
  ...
  useEffect(() => {
    ...
    getBanksListNotForSaleUserAction(dispatch);
                  ...
                  <TextField
                    ...
                    onChange={(e) => {
                      if (e.target.value.length <= 13) {
                        return onChange(e.target.value, "cnic");
                      }
                    }}
                    size="medium"
                    onKeyPress={(event) => {
