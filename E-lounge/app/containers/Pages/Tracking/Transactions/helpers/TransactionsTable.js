...
import { getAllTransactionHistoryForManagementApi } from "../../../../../redux/modules/Tracking/action";
...
const TransactionsTable = () => {
  ...
  const getAllTransaction = useSelector((state) =>
    state.getIn(["getAllTransactionHistoryForManagement"])
  );
  ...
  useEffect(() => {
    getAllTransactionHistoryForManagementApi(dispatch, pageLimit);
  }, [pageLimit]);
