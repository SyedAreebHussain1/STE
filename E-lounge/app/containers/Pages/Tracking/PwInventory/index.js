...
const PwInventoryTracking = () => {
  const title = "Pw Inventory";
  const description = "Pw Inventory";
        ...
        <Paper className={classNames(classes.root)} elevation={0}>
          ...
          >
            ...
            >
              ...
              {idSearch ? (
                <div
                  style={{ width: "15%", marginTop: "10px", margin: "5px 5px" }}
                >
...
export default PwInventoryTracking;
