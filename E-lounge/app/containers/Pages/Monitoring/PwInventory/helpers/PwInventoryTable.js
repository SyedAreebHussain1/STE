...
import { getAllSaleUserInventoriesForLeadAction } from "../../../../../redux/modules/Monitoring/action";
...
const PwInventoryTable = ({
  ...
  const getPwInventory = useSelector((state) =>
    state.getIn(["getAllSaleUserInventoriesForLead"])
  );
  ...
  useEffect(() => {
    getAllSaleUserInventoriesForLeadAction(
      dispatch,
      pageLimit,
      fullName,
