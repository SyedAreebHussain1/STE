...
import AssignedAgenciesTable from "./helpers/AssignedAgenciesTable";
...
const AssignedAgenciesManager = () => {
  const title = "AssignedAgencies";
...
export default AssignedAgenciesManager;
