...
const UpdateUsersModal: React.FC<ArchiveModalProps> = ({
  open,
  setOpen,
  updateData
}: ArchiveModalProps) => {
  const title = (
    <h3 className="!text-[1.17rem] !text-[#1D2939] !font-semibold ">
      Update User
    </h3>
  );
      ...
      >
        ...
        <Row gutter={16}>
          ...
          Name
            ...
            <TextInput className="h-[48px] rounded-md" value={ updateData?.companyUserProfile?.name} />
          </Col>
          <Col lg={12} sm={24} xs={24} md={24}>
            <span className="text-[#667085] font-medium text-[.975rem]  ">
              Email
            ...
            <TextInput className="h-[48px] rounded-md"  value={ updateData?.email} />
          </Col>
          <Col lg={12} sm={24} xs={24} md={24}>
            <span className="text-[#667085] font-medium text-[.975rem]  ">
              Phone No
            ...
            <TextInput className="h-[48px] rounded-md" value={updateData?.phoneNo} />
          </Col>
          <Col lg={12} sm={24} xs={24} md={24}>
            <span className="text-[#667085] font-medium text-[.975rem]  ">
              User ID
            ...
            <TextInput className="h-[48px] rounded-md" value={updateData?.id} />
          </Col>
          <Col lg={12} sm={24} xs={24} md={24}>
            <span className="text-[#667085] font-medium text-[.975rem]  ">
              Designation
            </span>
            <TextInput className="h-[48px] rounded-md" value={updateData?.companyRole?.title} />
          </Col>
          <Col lg={12} sm={24} xs={24} md={24}>
            <span className="text-[#667085] font-medium text-[.975rem]  ">
              Assign Role
