...
import { leadsUploadExcelByCampaignNameApi } from "../../../../../redux/api/SalesPlus/Campaigns";
...
const UploadLeadExcelFormModal = ({
  open,
  close,
  setBgBlurBox,
  setSearchValue,
  ...
  const fetchLead = () => {
    ...
    leadsUploadExcelByCampaignNameApi(
      dispatch,
        ...
        <Row gutter={16} className="py-1">
            ...
            <div className="min-h-[156px] rounded-[5px] p-[20px] bg-[#F2F4F7]">
              <div className="flex justify-between gap-1">
                ...
                <div>
                  ...
                  <h1 className="text-[#344054] text-[1rem] font-medium mt-3">
                    Sample Data:
                  </h1>
                  <img
                    src={excelImg}
          ...
          <Col sm={24} className="mt-5">
            <label
              ...
              className="text-[.8125rem] font-medium dark-input-label text-[#667085]"
            >
              Campaign Name
            </label>
            <TextInput
