...
import { addNewLeadFollowUpApi } from "../../../../../redux/api/SalesPlus/LeadDetails";
...
const FollowUpDaysUpdateModal = ({
  toggleId,
  setToggleId,
}: FollowUpDaysUpdateModalProps) => {
  ...
  return (
    <Modal
      ...
      footer={null}
    >
      <Form onFinish={onFinish} name="followUpDay">
        <Row gutter={16}>
