...
const Upload: React.FC<UploadProps> = ({
  ...
  return (
    <Spin spinning={loading}>
      <label htmlFor={name}>
        <div
          className="flex justify-center bg-transparent items-center cursor-pointer rounded-[5px] border-2 border-[#667085] border-dashed  py-[22px] dark:border-dark-borderColor"
          ref={drop}
        >
          <div>
            ...
            <div className="p-[10px] flex justify-center items-center flex-row mt-2">
            ...
            <div className="flex justify-center items-center ">
              ...
              >
                <span>Choose {label ? label : "File"}</span>
              </Button>
              <input
                type="file"
