...
interface SpiderChartModalFormI {
  form: any;
...
const SpiderChartModalForm = ({
  form,
  onFinish,
  formContent,
  setFormContent,
}: SpiderChartModalFormI) => {
  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col gap-2">
        ...
        <CollapsibleInputList title="Polar Radius Axis">
          <TextInput
...
export default SpiderChartModalForm;
