...
const Upload: React.FC<UploadProps> = ({
  ...
  return (
    <Spin spinning={loading}>
      {customContent && <div onClick={handleClick}> {customContent}</div>}
      <label htmlFor={name} className={customContent ? "w-0 h-0 !hidden" : ""}>
        <div
          className={
            customContent
              ? "w-0 h-0 !hidden"
              : "flex justify-center bg-transparent items-center cursor-pointer rounded-xl border border-strokes  py-[22px] dark:border-dark-borderColor"
          }
          ref={drop}
        >
          <div>
            ...
            <div className="p-[10px] flex justify-center items-center flex-col mt-2">
              <p className="text-[0.813rem] font-medium text-[#667085] text-center dark:text-dark-borderColor">
                Drag & drop your files here Choose file
              </p>
              {supportedText && (
                <p className="text-[12px] font-medium text-[#929292] mt-[2px] mb-[10px] dark:text-dark-borderColor">
                  {supportedText}
                </p>
              )}
            </div>
            <div className="flex justify-center items-center ">
              ...
              {/* <Button
                onClick={handleClick}
                className="btn-primary py-[12px] px-[25px] flex items-center shadow-none justify-center  border-[0] text-primary text-[1rem] font-medium gap-2 underline dark:text-dark-borderColor dark:hover:!bg-transparent"
              >
                <RoundedButton title={"Browse for images"} type="grey" sm />
              </Button> */}
              <input
                type="file"
