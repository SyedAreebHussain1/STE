...
const ContactUs = () => {
  return (
    <div className="flex w-full justify-center mt-[20px] lg:mt-[50px] px-[20px] lg:p-0">
      <div className="flex w-full lg:w-[1200px] justify-center h-[520px] ">
        ...
        <div className="w-full h-full flex flex-col justify-center xs:px-[40px] lg:px-[0] ">
          ...
          <div className="flex flex-col gap-2 mt-[20px]">
            ...
            />
            <div className="flex justify-start lg:justify-end mt-[8px]">
