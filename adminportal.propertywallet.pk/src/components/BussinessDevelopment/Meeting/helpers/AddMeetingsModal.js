...
import { createMeetingInBDApi } from '../../../../redux/api/BDMeeting'

const AddMeetingsBDModal = ({ visible, toggle }) => {
  const [form] = useForm()
  ...
  function onFinish(values) {
    ...
    createMeetingInBDApi(dispatch, body, onSuccess)
  }
          ...
          >
            ...
            <div className="flex justify-end mt-[55px]">
              <Button
                ...
                htmlType="submit"
                loading={CreateBDMeeting?.loading}
              >
                Add Now
              </Button>
            </div>
...
export default AddMeetingsBDModal
