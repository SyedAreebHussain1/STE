...
import { postELManagmentUserWithdrawAmountApi } from '../../../../redux/api/ELoungeManagmentWithdraw'

const ManagmentRejModal = ({ visible, toggle, data }) => {
  ...
  const onFinish = (e) => {
    ...
    postELManagmentUserWithdrawAmountApi(body, data.id, dispatch, onSuccess)
  }
  function onSuccess() {
    form.resetFields()
    toggle()
...
export default ManagmentRejModal
