...
import { createSurveyApi } from '../../../redux/api/Survey'

const AddModal = ({ visible, toggle }) => {
  const [form] = useForm()
  ...
  function onFinish(values) {
    ...
    createSurveyApi(dispatch, body, onSuccess)
  }
  ...
  return (
    <Modal
      title={<h3 className="text-[18px] font-semibold">Add Survey Details</h3>}
      open={visible}
      onCancel={onCancel}
      footer={null}
      centered={true}
