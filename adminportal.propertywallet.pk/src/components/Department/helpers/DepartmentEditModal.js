...
import { EditDepartmentApi } from '../../../redux/api/Department'
import TextField from '../../../utils/components/InputFields/TextField'
const DepartmentEditModal = ({ visible, toggle, data }) => {
  ...
  const onFinish = (e) => {
    ...
    EditDepartmentApi(dispatch, body, data.id, onSuccess)
  }
  function onSuccess() {
    form.resetFields()
    toggle()
  ...
  useEffect(() => {
    form.setFieldValue('departmentName', data.title)
  }, [data])
        ...
        >
          ...
          <div className="flex justify-end ">
            ...
            <Button
              ...
              loading={EditDepartment.loading}
              htmlType="submit"
            >
              Add
            </Button>
