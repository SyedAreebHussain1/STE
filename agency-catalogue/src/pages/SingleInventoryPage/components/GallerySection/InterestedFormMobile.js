...
const InterestedFormMobile = () => {
  const [form] = useForm();
  return (
    <div className="relative top-6 w-full p-[18px] bg-[#DEE0E3] rounded-lg">
      <div>
            ...
            <Row gutter={16}>
              ...
              <Col sm={24} xs={24} lg={24} className="mt-[22px]">
                <div className="flex justify-around gap-2">
                  <button
                    className={`w-full px-[2px] py-[2px] border-[1px] border-[#C7C1C1] text-[1rem] text-[#344054] bg-[#DEE0E3] rounded-[10px]  transition hover:bg-[whitesmoke]`}
                  >
                    Book Appointment
                  </button>
                  <button
...
export default InterestedFormMobile;
