...
const WalletStatistics = (props) => {
  ...
  return (
    <div className={classes.rootCounterFull}>
      {SuccessModal && <SuccessModal visible={successModalVisible} close={toggleSuccessModal} />}
      {open && <WithdrawAmountWalletModal open={open} close={toggleModal} toggleSuccessModal={toggleSuccessModal} />}
