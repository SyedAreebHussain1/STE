const API = {
  ...
  milestones: {
    getMilestonesAndCount: "milestones/getMilestoneAndCountAndCommission",
    assignMilestonesToFreelancer: "milestones/assignMilestonesToFreelancer",
    getMilestonesCertificate: "milestones/getFreelancerAchievedMilestone",
  },
  forgetPassword: {
    withEmail: "free-lancer/forgot-password",
    verifyOtp: "free-lancer/fp-code-verify",
    change: "free-lancer/reset-password"
  }
};
export { API };
