...
import { changePasswordAction, forgotPasswordVerifyOtpAction, forgotPasswordWIthEmailAction } from "../../redux/modules/ForgotPassword/actions";
...
function ResetForm(props) {
  ...
  const forgotPasswordOtpVerify = useSelector(state => state.getIn(["forgotPasswordOtpVerify"]))
  const changePassword = useSelector(state => state.getIn(["changePassword"]))
  const forgotPasswordWithEmail = useSelector(state => state.getIn(["forgotPasswordWithEmail"]))
  ...
  function handleSubmitChange(e){
    ...
    changePasswordAction(body, onSuccessChange, dispatch, forgotPasswordOtpVerify.data.data.token)
  }
  return (
