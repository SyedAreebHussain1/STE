...
import AdvTableDemo from "../../containers/Tables/demos/AdvTableDemo";
import AllMeetingsessions from "../../containers/Pages/AllMettingsessions";
import Bookedsessions from "../../containers/Pages/AllBookedsessions";
        ...
        <AppBar position="static" color="default">
          ...
          <Hidden smDown>
            <Tabs
              ...
              variant="fullWidth"
            >
              <Tab label="All sessions" icon={<Call />} />
              <Tab label="Manage booking" icon={<AccessTime />} />
            </Tabs>
          </Hidden>
        </AppBar>
        {value === 0 && (
