    ...
    <div className="relative">
      ...
      >
        ...
        <div className="bg-white w-[140px] h-[8px] rounded-[.5rem]">
          <div className="bg-primary h-[8px] w-[40%] rounded-[.5rem]"></div>
        </div>
      ...
      <div
        className={`absolute z-10 left-0 top-[114%] w-full rounded-[.5rem] bg-red-600 shadow-lg onboarding-container ${open && "onboarding-container-active"
          }`}
      >
