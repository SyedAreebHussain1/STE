...
import logoIcon from "../../assets/uploadLogo.png";
...
const LogosUpload: React.FC<UploadProps> = ({
  files: filesState,
  setFiles,
  name,
  supportedFileTypes,
  ...
  return (
    <Spin spinning={loading}>
      <label htmlFor={name}>
        <div
          className={`flex justify-center bg-transparent items-center cursor-pointer
        rounded-[5px] border-2 border-[#EAECF0]  py-[10px] w-[200px]`}
          ref={drop}
        >
          <input
            type="file"
          ...
          ></input>
          <div
            className="flex justify-center items-center w-full gap-2 h-full
            "
            onClick={(e: any) => {
              handleClick(e);
            }}
          >
            <img src={logoIcon} />
            <div className="font-medium text-[1rem]">Replace Logo</div>
          </div>
        </div>
      </label>
    </Spin>
